...
INSERT INTO `seckill_coupon` VALUES (1,1,'100元优惠券',100.00,50.00,100,1,1,'2026-04-12 12:43:45','2026-04-12 12:43:45',NULL,NULL),(2,1,'200元优惠券',200.00,100.00,50,1,1,'2026-04-12 12:43:45','2026-04-12 12:43:45',NULL,NULL),(3,1,'300元优惠券',300.00,150.00,30,1,1,'2026-04-12 12:43:45','2026-04-12 12:43:45',NULL,NULL),(4,2,'夏季折扣券',50.00,25.00,200,2,1,'2026-04-13 12:43:45','2026-04-13 12:43:45',NULL,NULL),(5,5,'春季新品券',150.00,75.00,150,1,1,'2026-04-14 12:43:45','2026-04-14 18:54:06',NULL,NULL);
...
CREATE TABLE `shopping_cart` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='购物车';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-19 16:21:20
