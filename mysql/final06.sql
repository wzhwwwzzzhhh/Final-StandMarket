...
CREATE TABLE `orders` (
  ...
  `original_price` decimal(10,2) DEFAULT NULL COMMENT '原价',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2233 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='订单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2204 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='秒杀订单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `seckill_order` VALUES (7,20,3,'583053922239774722',1,'2026-04-21 13:07:01',NULL);
...
-- Dump completed on 2026-04-21 14:00:17
